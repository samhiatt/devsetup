...
if main_syntax != 'java' || exists("java_javascript")
  " JAVA SCRIPT
  syn include @htmlJavaScript /usr/share/vim/vim74/javascript.vim
...
if main_syntax != 'java' || exists("java_vb")
  " VB SCRIPT
  syn include @htmlVbScript /usr/share/vim/vim74/vb.vim
  unlet b:current_syntax
...
if main_syntax != 'java' || exists("java_css")
  ...
  syn include @htmlCss /usr/share/vim/vim74/css.vim
  unlet b:current_syntax
